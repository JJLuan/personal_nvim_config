...
function! TransformXSLT(open)
    if s:xml_input=="" || s:xslt==""
       echoerr "s:xml_input ". s:xml_input . ", s:xslt ".s:xslt
    else
        execute "!xsltproc -o ./output/output.xml ".s:xslt." ".s:xml_input
    endif
...
command! Ts execute "call TransformXSLT(0)"
command! To execute "call TransformXSLT(1)"
command! Pj execute "set syntax=json | %! python -mjson.tool"
